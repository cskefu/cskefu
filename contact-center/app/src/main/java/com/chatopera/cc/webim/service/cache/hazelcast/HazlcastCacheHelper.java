 ...
 */
package com.chatopera.cc.webim.service.cache.hazelcast;

import com.chatopera.cc.core.UKDataContext;
import com.chatopera.cc.webim.service.cache.CacheBean;
import com.chatopera.cc.webim.service.cache.CacheInstance;
import com.chatopera.cc.webim.service.cache.hazelcast.impl.AgentStatusCache;
import com.chatopera.cc.webim.service.cache.hazelcast.impl.AgentUserCache;
import com.chatopera.cc.webim.service.cache.hazelcast.impl.ApiUserCache;
import com.chatopera.cc.webim.service.cache.hazelcast.impl.CallCenterCache;
import com.chatopera.cc.webim.service.cache.hazelcast.impl.JobCache;
import com.chatopera.cc.webim.service.cache.hazelcast.impl.MultiCache;
import com.chatopera.cc.webim.service.cache.hazelcast.impl.OnlineCache;
import com.chatopera.cc.webim.service.cache.hazelcast.impl.SystemCache;
/**
 * Hazlcast缓存处理实例类
 * @author admin
 *
