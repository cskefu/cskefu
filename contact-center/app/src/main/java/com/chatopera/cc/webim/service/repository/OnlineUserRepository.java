...
public abstract interface OnlineUserRepository extends JpaRepository<OnlineUser, String> {
    ...
    public abstract  OnlineUser findByPhoneAndOrgi(String mobile, String orgi);

    public abstract  OnlineUser findByPhoneAndOrgiAndStatus(String mobile, String orgi, String status);
