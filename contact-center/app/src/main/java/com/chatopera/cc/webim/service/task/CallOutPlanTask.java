...
import com.chatopera.cc.webim.service.repository.CallOutTargetRepository;
import com.chatopera.cc.webim.web.model.CallOutDialplan;
import com.chatopera.cc.webim.web.model.CallOutTarget;
...
public class CallOutPlanTask {
    ...
    public void watch() {
        ...
        // load all jobs
        List<CallOutDialplan> dps = callOutDialplanRes.findByStatusAndIsarchive(UKDataContext.CallOutDialplanStatusEnum.RUNNING.toString(), false);
    ...
    public void run(final CallOutDialplan dp, final JsonArray sips) throws CallOutRuntimeException {
        ...
        try (Stream<CallOutTarget> stream = callOutTargetRes.findAllByOrgiAndInvalidAndDialplan(UKDataContext.SYSTEM_ORGI, false, dialplanId)) {
            ...
            payload2.addProperty("status", UKDataContext.CallOutDialplanStatusEnum.RUNNING.toString());
