 ...
 */
package com.chatopera.cc.concurrent.multiupdate;

import com.chatopera.cc.app.basic.MainContext;
import com.lmax.disruptor.EventHandler;
import com.chatopera.cc.concurrent.user.UserDataEvent;
import com.chatopera.cc.concurrent.dsdata.ESData;
	...
	public void onEvent(UserDataEvent event, long arg1, boolean arg2)
		...
		if(event.getEvent()!=null){
			...
			if(multiEventEvent.getData() instanceof ESData){
				...
				if(MainContext.MultiUpdateType.SAVE.toString().equals(multiEventEvent.getEventype())){
					multiEventEvent.getCrudRes().delete(multiEventEvent.getData()) ;
					multiEventEvent.getCrudRes().save(multiEventEvent.getData()) ;
				}else if(MainContext.MultiUpdateType.DELETE.toString().equals(multiEventEvent.getEventype())){
					multiEventEvent.getCrudRes().delete(multiEventEvent.getData()) ;
				}
			}
		}
