...
import com.chatopera.cc.webim.service.repository.UKefuCallOutRoleRepository;
...
import com.chatopera.cc.webim.service.repository.SaleStatusRepository;
...
import com.chatopera.cc.webim.web.model.UKefuCallOutRole;
...
public class CallCenterUtils {
	...
	public static void getAllCallOutList(ModelMap map, User user,String ownerdept, String actid){
		...
		UKefuCallOutRoleRepository callOutRoleRes = UKDataContext.getContext().getBean(UKefuCallOutRoleRepository.class) ;
		...
		map.put("taskList",UKDataContext.getContext().getBean(UKefuCallOutTaskRepository.class).findByActidAndOrgi(actid, user.getOrgi()));
	...
	public static void getAgentRenum(UKefuCallOutTask task, JobDetail batch, UKefuCallOutFilter ukefuCallOutFilter){
		...
		UKefuCallOutTaskRepository callOutTaskRes = UKDataContext.getContext().getBean(UKefuCallOutTaskRepository.class) ;
		JobDetailRepository batchRes = UKDataContext.getContext().getBean(JobDetailRepository.class) ;
		UKefuCallOutFilterRepository callOutFilterRes = UKDataContext.getContext().getBean(UKefuCallOutFilterRepository.class) ;
