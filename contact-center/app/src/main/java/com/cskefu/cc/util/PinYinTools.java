...
public class PinYinTools {  
    ...
    public static final String[] pystr = new String[] {"A", "AI", "AN", "ANG", "AO", "BA", "BAI", "BAN", "BANG", "BAO", "BEI", "BEN", "BENG", "BI", "BIAN",
    ...
    private static final PinYinTools characterParser = new PinYinTools();
