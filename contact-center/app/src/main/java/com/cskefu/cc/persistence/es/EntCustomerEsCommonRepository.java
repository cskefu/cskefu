...
import com.cskefu.cc.model.EntCustomer;
...
public interface EntCustomerEsCommonRepository {
	...
	Page<EntCustomer> findByCreaterAndSharesAndOrgi(String creater, String shares, String orgi, boolean includeDeleteData, String q, Pageable page) ;
