...
public class URLImageSource extends AbstractImageSource<URL>
{
	...
	/**
	 * The proxy to use to callOutConnect to the image URL.
	 * <p>
	 ...
	 * to callOutConnect to the aforementioned URL.
	 * 
	 * @param url		URL to the source image.
	 * @param proxy		Proxy to use to callOutConnect to the URL.
	 ...
	 * source image.
	 * 
	 * @return the proxy	The proxy used to callOutConnect to a URL.
	 */
